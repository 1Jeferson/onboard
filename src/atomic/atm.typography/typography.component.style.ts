...
export const typographyStyle = tv({
  ...
  variants: {
    variant: {
      ...
      b1: 'font-regular font-secondary text-small text-gray-dark leading-snug',
      b2: 'font-regular font-secondary !text-x-small leading-snug text-gray-dark',
      link: 'font-secondary font-semibold text-x-small leading-snug text-brand-primary-dark',
